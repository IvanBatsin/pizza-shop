...
import { PizzaCartBlock, CartEmpty } from '../components/';
import { clearCart, removeCartItem, minusOneItem, plusOneItem } from '../redux/actions/cart';
...
export default function Cart(){
  ...
  const clearCartHandler = () => {
    if (window.confirm('Удалить весь заказ?')) dispatch(clearCart());
  }
  ...
  if (!totalCount) return <CartEmpty></CartEmpty>
        ...
        <div className="cart">
          ...
          <div className="content__items">
            {addedPizzas.map(pizza => {
              return <PizzaCartBlock 
                  plusOne={plusOneHandler}
                  minusOne={minusOneHandler}
